...
class SpeedtestResults(object):
    ...
    def __init__(self, download=0, upload=0, ping=0, server=None, client=None,
        ...
        self._share = None       
        self.timestamp = f"{datetime.now(UTC).isoformat()}Z"
...
def shell():
    ...
    printer('\033[1mTesting from %(isp)s...\033[0m\n' % speedtest.config['client'],
            quiet)
    ...
    printer('\n.........................................................\n\033[1mHosted by:\033[0m %(sponsor)s\n\033[1mLocation:\033[0m %(name)s [%(d)0.2f km] '
            '\n\033[1mPing :\033[0m %(latency)s ms' % results.server, quiet)
    ...
    if args.download:
        ...
        printer('\033[1mDownload:\033[0m %0.2f M%s/s' %
    ...
    if args.upload:
        speedtest.upload()
        printer('\033[1mUpload:\033[0m %0.2f M%s/s' %
                ((results.upload / 1000.0 / 1000.0) / args.units[1],
                 args.units[0]),
                quiet)
        printer("\n..................................................\nPOWERED BY \033[1mSpeedtest Ookla\033[0m\nScript made by \033[1mDitzDev\033[0m")
    else:
